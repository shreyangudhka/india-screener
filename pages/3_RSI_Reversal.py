...
if st.button("🗑️ Clear cache & re-scan fresh", key="clr_rsi"):
    clear_cache("rsi")
    if "rsi_results" in st.session_state:
        del st.session_state["rsi_results"]
    st.rerun()
