...
if st.button("🗑️ Clear cache & re-scan fresh", key="clr_trend"):
    clear_cache("trend")
    if "adx_results" in st.session_state:
        del st.session_state["adx_results"]
    st.rerun()
